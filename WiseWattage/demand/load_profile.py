...
def initialise_load(self):
    ...
    logging.info(
        "Load Profile Generated:\n"
        f"Daily Electricity Use: {self.daily_electric}kWh\n"
        f"Annual Electricity Use: {self.annual_electric}kWh\n"
        f"Daily Variability: {self.daily_variablity*100}%\n"
