...
- Added constraints based on Inverter input and output
- Added battery calculations and optimised performance, model iterates over every dataframe to accurately track and update SoC. 
- Added further returns to models in order to track losses and energy flows better.
...
- Updated SolarPVModel save method to save all models + combined model
